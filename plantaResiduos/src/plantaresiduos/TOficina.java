 ...
 */
public class TOficina extends Trabajador{
     ...
     */
    public TOficina(String nif, String nombre, String apellidos, String telefono, String direccion, String departamento)throws Exception {
     ...
     */
    public void generarNomina(int id, int mes, int anio, double cant) throws Exception{
